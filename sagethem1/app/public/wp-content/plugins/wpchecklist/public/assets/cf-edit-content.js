export default {
  updateTitle: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.",
  updateDescription: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.",
  addH1: `<h1>What is Lor<a href='#'>em I</a>psum?</h1>`,
  addH2: `<h2>What is Lor<a href='#'>em I</a>psum?</h2>`,
  addH3: `<h3>What is Lor<a href='#'>em I</a>psum?</h3>`,
  addH4: `<h4>What is Lor<a href='#'>em I</a>psum?</h4>`,
  addH5: `<h5>What is Lor<a href='#'>em I</a>psum?</h5>`,
  addH6: `<h6>What is Lor<a href='#'>em I</a>psum?</h6>`,
  addAlOl: `<ul>
...
<td ><strong>Lorem Ipsum</strong>&nbsp;is simply dummy text of the prin<a href="#">ting and typesetting i</a>ndustry. <strong>Lorem Ipsum</strong>&nbsp;is simply dummy text of the prin<a href="#">ting and typesetting i</a>ndustry</td>
<td >
<ul>
  <li><strong>Lorem Ipsum</strong>&nbsp;is simply dummy text of the prin<a href="#">ting and typesetting i</a>ndustry</li>
  <li><strong>Lorem Ipsum</strong>&nbsp;is simply dummy text of the prin<a href="#">ting and typesetting i</a>ndustry</li>
...
<tr>
<td ><strong>Lorem Ipsum</strong>&nbsp;is simply dummy text of the prin<a href="#">ting and typesetting i</a>ndustry. <strong>Lorem Ipsum</strong>&nbsp;is simply dummy text of the prin<a href="#">ting and typesetting i</a>ndustry <strong>Lorem Ipsum</strong>&nbsp;is simply dummy text of the prin<a href="#">ting and typesetting i</a>ndustry <strong>Lorem Ipsum</strong>&nbsp;is simply dummy text of the prin<a href="#">ting and typesetting i</a>ndustry</td>
<td><strong>Lorem Ipsum</strong>&nbsp;is simply dummy text of the prin<a href="#">ting and typesetting i</a>ndustry</td>
<td>
...
<h4><strong>Lorem Ipsum</strong>&nbsp;is simply dummy text of the prin<a href="#">ting and typesetting i</a>ndustry</h4>
  ...
  // ``,
  bg: 'https://i.picsum.photos/id/574/1000/1000.jpg',
  add2Button: '<p><a href="#" class="btn btn-custom">Lorem Ipsum button</a><a href="#" class="btn btn-custom">Lorem Ipsum button</a></p>',
  addButton: '<p><a href="#" class="btn btn-custom">Lorem Ipsum button</a></p>',
  imageLeft: `<p><strong><img class="size-full wp-image-547 alignleft" src="https://i.picsum.photos/id/574/200/200.jpg" alt="Pine Mountain" width="200" height="200" />Lorem Ipsum</strong> is simply dummy text of the prin<a href="#">ting and typesetting i</a>ndustry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>`,
  imageRight: `<p><strong><img class="size-full wp-image-545 alignright" src="https://i.picsum.photos/id/574/200/200.jpg" alt="GP" width="200" height="200" />Lorem Ipsum</strong> is simply dummy text of the prin<a href="#">ting and typesetting i</a>ndustry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>`,
  imageCenter: `<p><strong><img class="size-full wp-image-545 aligncenter" src="https://i.picsum.photos/id/574/200/200.jpg" alt="GP" width="200" height="200" />Lorem Ipsum</strong> is simply dummy text of the prin<a href="#">ting and typesetting i</a>ndustry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>`,
  svg: 'https://cdn.agilitycms.com/9th-wonder/Attachments/9thwonder%20assets/logo-R-home.svg',
  oneP: `  <p><strong>Lorem Ipsum</strong> is simply dummy text of the prin<a href='#'>ting and typesetting i</a>ndustry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>`,
  twoP: `  <p><strong>Lorem Ipsum</strong> is simply dummy text of the prin<a href='#'>ting and typesetting i</a>ndustry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
  ...
  allContent: `<h2>What is Lor<a href='#'>em I</a>psum?</h2>
  <p><strong>Lorem Ipsum</strong> is simply dummy text of the prin<a href='#'>ting and typesetting i</a>ndustry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
